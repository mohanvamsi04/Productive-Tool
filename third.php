    ...
    <style>
      ...
      * {
      ...
      .content {
        ...
        padding: 1rem;
        font-size: 1rem;
        background: linear-gradient(45deg, #d1bb9e, #fff2e1);
      }
  ...
  <body>
    ...
    <div class="mcontainer">
      <div class="flex-container1">
        <div class="items1 i11">Olympus</div>
        <a href="tasks.php"><div class="items1 i21">Siemens Gamesa Renewable Energy</div></a>
        <div class="items1 i31">Alstom</div>
        <div class="items1 i41">Siemens Energy</div>
        <a href="second.php"
          ><div class="items1 i51">Cargotec Corporation</div></a
        >
        <div class="items1 i61">Akzonobel</div>
      </div>
    </div>
